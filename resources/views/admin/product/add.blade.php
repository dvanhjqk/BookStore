...
<body>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="row g-3" action="{{ route('product_add') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Tên sách</label>
                    <input type="text" value="{{ old('pro_name') }}" name="pro_name" class="form-control">
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <input type="text" name="pro_price_sale" value="{{ old('pro_price_sale') }}" class="form-control">
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" style="height: 100px" name="pro_description">{{ old('pro_description') }}</textarea>
                    </div>
                </div>
                <div class="row mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="pro_category_id">
                            ...
                            @if (!empty($category))
                                ...
                                @foreach ($category as $c)
                                    <option value="{{ $c->id }}"
                                        {{ old('pro_category_id') == $c->id ? 'selected' : false }}>
                                        {{ $c->c_name }}</option>
                                @endforeach
                            @endif
                            }
                        ...
                        <select class="form-select" aria-label="Default select example" name="pro_publisher_id">
                            ...
                            @if (!empty($publisher))
                                ...
                                @foreach ($publisher as $p)
                                    <option value="{{ $p->id }}"
                                        {{ old('pro_publisher_id') == $p->id ? 'selected' : false }}>
                                        {{ $p->p_name }}</option>
                                @endforeach
                            @endif
                            }
                        ...
                        <select class="form-select" aria-label="Default select example" name="pro_supplier_id">
                            ...
                            @if (!empty($supplier))
                                ...
                                @foreach ($supplier as $sup)
                                    <option value="{{ $sup->id }}"
                                        {{ old('pro_supplier_id') == $sup->id ? 'selected' : false }}>
                                        {{ $sup->sup_name }}</option>
                                @endforeach
                            @endif
                            }
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="pro_author_id">
                            ...
                            @if (!empty($author))
                                ...
                                @foreach ($author as $a)
                                    <option value="{{ $a->id }}"
                                        {{ old('pro_author_id') == $a->id ? 'selected' : false }}>
                                        {{ $a->a_name }}</option>
                                @endforeach
                            @endif
                            }
